export class Datas {
    constructor(documentType, firstName, lasttName, address, country, town, zip, product, price, quantity, tva, date) {
    ...
    htmlFormat() {
        ...
        <div class="row pb-5 p-5">
            ...
            <div class="col-sm-6 text-right">
                ...
                <p class="mb-1">Mr/Mme ${this.firstName} ${this.lasttName}</p>
